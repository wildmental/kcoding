    ...
    <div class="navbar navbar-wp navbar-arrow mega-nav" role="navigation" style="background:#000000;">
        ...
        <div class="navbar-collapse collapse" style="color:white;">
            <ul class="nav navbar-nav navbar-right" style="color:white;">
                <li class="hidden-md hidden-lg" style="color:white;">
                    <div class="bg-light-gray" style="color:white;">
                        <form class="form-horizontal form-light p-15" role="form">
                            <div class="input-group input-group-lg" style="color:white;">
                ...
                <li class="dropdown" style="color:white;">
                    <a href='#' class="dropdown-toggle"><span style="color:white;"><fmt:message key="ANAL1"/></span></a>
                </li>
                 <li class="dropdown" style="color:white;">
